...
public static class Ui
{
    ...
    public static Frame CardFrame(View content) => new()
    {
        Content = content, BackgroundColor = Card, BorderColor = Color.FromArgb("#29292E"),
        CornerRadius = 18, Padding = 16, HasShadow = false, Margin = new Thickness(0, 5)
    };
